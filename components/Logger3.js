  ...
  return (
    <View style={styles.container}>
      <View style={styles.statusContainer}>
        <Text style={styles.statusText}>STATUS: NEEDS MAINTENANCE</Text>
      </View>
      ...
      <View style={styles.infoContainer}>
        ...
        <View style={styles.infoBox}>
          <Icon name="battery-half" size={30} color="red" />
          <Text style={styles.infoText}>Battery: 20%</Text>
        </View>
      ...
      <View style={[styles.infoBox, styles.dataSentBox]}>
        <Text style={styles.infoText}>Data Sent: 33%</Text>
      ...
      <View style={styles.barChartContainer}>
        <BarChart
          ...
          width={screenWidth - 32} // Adjust width to fit within padding
          height={220}
          chartConfig={{
            backgroundColor: '#ffffff',
            backgroundGradientFrom: '#ffffff',
